...
<head>
    ...
    <style>#outlook a {
        ...
        a {
            color: <?php echo $admin_settings['color_scheme'][0]->value; ?>;
            text-decoration: none;
        }

        a:hover {
            color: <?php echo $admin_settings['color_scheme'][0]->value; ?> !important;
        }
        ...
        table.button td, table.tiny-button td, table.small-button td, table.medium-button td, table.large-button td {
            ...
            text-align: center;
            background: <?php echo $admin_settings['color_scheme'][0]->value; ?>;
            border: 1px solid <?php echo $admin_settings['color_scheme'][0]->value; ?>;
            color: #ffffff;
            padding: 8px 0;
        }
        ...
        table.button:hover td, table.button:visited td, table.button:active td {
            background: <?php echo $admin_settings['color_scheme'][0]->value; ?> !important;
        }
                                            ...
                                            <table class="twelve columns">
                                                <tr>
                                                    <td class="six sub-columns">
                                                        <img src="<?php echo base_url('assets/themes/default/images/logo.jpg'); ?>">
                                                    </td>
                                                    <td class="six sub-columns last" align="right"
                                ...
                                <tr>
                                    <td class="wrapper last">
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <h1>Hi, <?php echo $f_name; ?></h1>
                                                    <p class="lead">Thanks for joining us! There is only one more step to complete your registration.</p>
                                                </td>
                                                <td class="expander"></td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="button">
                                                        <tr>
                                                            <td>
                                                                <a href="<?php echo base_url('create-account/activate/'.$id.'/' . $activation); ?>">Activate My Account</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table class="six columns">
                                            <tr>
                                                <td class="left-text-pad">
                                                    ...
                                                    <?php
                                                    if ($admin_settings['social']) {
                                                        $socials = '';
                                                        foreach ($admin_settings['social'] as $row) {
                                                            $socials .= '<table class="tiny-button ' . str_replace('_', '-', $row->field_name) . '">
                                                                <tr>
                                                                    <td>
                                                                        <a href="' . $row->field_name . '">' . $row->label . '</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <br>';
                                                        }
                                                        echo rtrim($socials, '<br>');
                                                    }
                                                    ?>
                                                </td>
                                                <td class="expander"></td>
                                        ...
                                        <table class="six columns">
                                            <tr>
                                                <td class="last right-text-pad">
                                                    ...
                                                    <?php
                                                        $contact = '';
                                                        if(isset($admin_settings['contact'])){
                                                            foreach($admin_settings['contact'] as $row) {
                                                                if($row->field_name == 'admin_email') {
                                                                    echo '<p>'.$row->label.': <a href="mailto:'.$row->value.'">'.$row->value.'</a></p>';
                                                                } else if($row->field_name == 'admin_phone') {
                                                                    echo '<p>'.$row->label.': ';
                                                                    echo "(".substr($row->value, 0, 3).") ".substr($row->value, 3, 3)."-".substr($row->value,6);
                                                                    echo '</p>';
                                                                } else {
                                                    ...
                                                    ?>
                                                    <p><a href="http://digitalhorseshow.com/contact-us/">http://digitalhorseshow.com/contact-us/</a></p>
                                                </td>
                                                <td class="expander"></td>
                                            </tr>
                                        </table>
                                                ...
                                                <td align="center">
                                                    <center>
                                                        <p style="text-align:center;">
                                                            <?php
                                                                $links = '';
                                                                if(isset($admin_settings['social'])){
                                                                    foreach($admin_settings['email_footer'] as $row) {
                                                                        $links .= '<a href="'.$row->value.'" target="_blank">'.$row->label.'</a> | ';
                                                                    }
                                                                    echo rtrim($links, ' | ');
                                                                }
                                                            ?>
...
<body>
	...
	<p><?php echo sprintf(lang('email_activate_subheading'), anchor('create-account/activate/' . $id . '/' . $activation, lang('email_activate_link'))); ?></p>
</body>
</html> -->